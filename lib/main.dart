...
class TeamDeviceHomePage extends StatelessWidget {
  ...
  static const String groupName = '第二组 创新实验团队';
  ...
  static const List<TeamMember> members = [
    TeamMember(role: '组长', name: '唐志伟', task: '创建原始仓库、维护 main、审核 PR、组织真机运行与证据提交'),
    TeamMember(role: '组员 A', name: '王梓桓', task: '修改 groupName、projectTitle、projectSlogan'),
    TeamMember(role: '组员 B', name: '李学海', task: '补全 members 中的成员姓名与分工'),
    TeamMember(role: '组员 C', name: '刘炎松', task: '补充 realDeviceChecks 中的真机运行检查项，补充 evidenceRules 并把真机照片加入 README'),
  ];
